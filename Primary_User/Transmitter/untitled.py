...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_sink_0.set_samplerate(1024000)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\anjan\\Downloads\\SDR_Data\\Primary_User\\Transmitter\\input_bins\\symbols_01.bin', True, 0, 0)
